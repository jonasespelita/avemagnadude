...
<!-- VIDEO BG HERE ~ JONAS -->
	<video muted autoplay loop poster="background-img/test.jpg" id="bgvid">

		<source src="background-vids/demo.webm" type="video/webm">

		<source src="background-vids/demo.mp4" type="video/mp4">
